package com.spring5tutorial.sam.photoappapiusers.security;
...
import com.spring5tutorial.sam.photoappapiusers.model.LoginUserRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            LoginUserRequestModel creds = new ObjectMapper().readValue(req.getInputStream(),
